...
(function pullPagePullImplementation($) {
  ...
  function gotPullDownData(event, data) {
		...
		var i, newContent = '<li><a href="#"><span class="image-holder"><img src="images/content/image-01.jpg" alt="straighten up" /></span><span class="content-holder"><h2>New Straighten Up</h2><p>Lorem ipsum dolor sit amet, consectetur adipiscing elit donec accum...</p></span></a></li>';
	  
		var activePageId = $.mobile.activePage.attr('id');
		if(activePageId=="blog-index") {
		  ...
		  blogpagefunc(nvLangFileName);
			...
			//fetchblogdatafunc();
			return false;
			//$("#bloglistview").prepend(newContent).listview("refresh");  // Prepend new content and refresh listview
